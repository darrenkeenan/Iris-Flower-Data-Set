...
with open("data/iris.csv") as iris:                             # opening file iris.csv saved on computer
    for cmandname in iris:                     
        ...
        print(i[1],i[4])                                        # listing column 2 in file, sepal width & column 5, spcies/class of iris
